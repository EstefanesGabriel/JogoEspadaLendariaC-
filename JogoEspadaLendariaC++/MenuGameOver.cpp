...
namespace EspadaLendaria {
    ...
    namespace Menu {
            ...
            gerenciadorArquivo()
        {
            ...
            if (!textura->loadFromFile("img/Menu/caixaTexto.png")) {
                std::cout << "EspadaLendaria::Menu::MenuGameOver::nao foi possivel carregar textura" << std::endl;
                exit(1);
            }
        ...
        void MenuGameOver::salvarColocacao() {
            ...
            gerenciadorArquivo.gravarConteudo("arquivo/Colocacao/colocacao.txt", linha);
        }
