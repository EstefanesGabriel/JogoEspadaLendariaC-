    ...
    namespace Entidade {
        ...
        namespace Personagem {
            ...
            Personagem::Personagem(const sf::Vector2f pos, const sf::Vector2f tam, const float vel, const IDs::IDs ID, const float tempoMorrer, const float tempoDano) :
                ...
                textoNivel(pGrafico->carregarFonte("fonte/Ancient Medium.ttf"), "", 15) //créditos da fonte a artRAVE Editions do site: https://www.dafont.com/pt/search.php?q=ancient
            {
